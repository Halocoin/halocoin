...
{"node1", "174.140.165.174"},
{"node2", "174.140.163.235"},
{"", ""},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. HaloCoin is probably already running."), addrBind.ToString().c_str());
        else
